...
<script>
    ...
    function userSetting(){
        ...
        for(var i=0; i <  userList.length; i++){
            ...
            var left = x * 100  -30
            html += '<div class="user-wrap" style="left:'+left+'"><button class="ladder-start" style="background-color:'+color+'" data-color="'+color+'" data-node="'+userList[i]+'"></button>';
            html +='</div>'
        }
        ladder.append(html);
    }
    function resultSetting(){
        ...
        var html = '';
         ...
         var val1 = "${ladder_Data.select2}";
         var val2 = "${ladder_Data.select3}";
         var val3 = "${ladder_Data.select4}";
         var val4 = "${ladder_Data.select5}";    
         var val5 = "${ladder_Data.select6}";        
