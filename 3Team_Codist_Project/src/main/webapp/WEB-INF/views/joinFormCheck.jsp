...
<html>
   ...
   <body>
  	...
  	<table id="agree" align="center">
		<tr>
			<td id="agree2">
				<textarea name="Stipulation" rows="15" cols="50" id="agree3">
제 1 조 (목적)
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.
		...
		<tr>	
			<td>
					<textarea name="Agreement" rows="15" cols="50" id="agree3">정보통신망법 규정에 따라 Codist가 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
1. 수집하는 개인정보
